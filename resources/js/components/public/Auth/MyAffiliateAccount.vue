                        ...
                        <table id="example2" class="table table-bordered table-hover" style="margin-bottom: 0px;">
                            ...
                            <tbody>
                                <tr v-for="(referralCourse, index) in ReferralCourses" :key="referralCourse.id">
                                    ...
                                    <!-- {{referrallink}} -->
                                    <td style="width:150px;padding:1px;" v-if="referralCourse.course">
                                             <img :src="courseLoadImage(referralCourse.course.image)" style="width:100%; height:auto" alt="Card image cap">
                                    </td>
