...
class CreateOrganisationAffiliateTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('organisation_affiliate', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('organisation_affiliate');
    }
}
