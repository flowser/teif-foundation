...
class OrgEmployeeController extends Controller
{
    ...
    public function index()
    {
        ...
        $employees = User::whereHas('organisationemployees', function($query) use($organisation)
                                {
    ...
    public function store(Request $request, $id)
    {
        ...
        if ($organisation){
            ...
            $user->user_type      = 'Organisation Employee';
            $user->password   = Hash::make($request->password);

            $user->assignRole('Organisation Employee');
            $user ->givePermissionTo('View Backend', 'View All');
                ...
                if($frontside_id){
                     ...
                     $fr_id_Path = public_path()."/assets/organisation/img/employees/IDs/front";
                ...
                if($backside_id){
                     ...
                     $bs_id_Path = public_path()."/assets/organisation/img/employees/IDs/back";
    ...
    public function update(Request $request, $id)
    {
       ...
       $user ->givePermissionTo('View Backend', 'View All');
           ...
           $currentPassport = $user->organisationemployees()->first()->pivot->photo;
           ...
           if($request->photo != $currentPassport){
            ...
            //   return $S_currentPassport;
               ...
               $photo = $user->organisationemployees()->first()->pivot->photo;
           }
          //front side id
          $currentFrontside_id = $user->organisationemployees()->first()->pivot->id_photo_front;
           ...
           if($request->id_photo_front != $currentFrontside_id){
               ...
               $id_photo_front = $user->organisationemployees()->first()->pivot->id_photo_front;
           }

           //backside id
           $currentBackside_id = $user->organisationemployees()->first()->pivot->id_photo_back;
           ...
           if($request->id_photo_back != $currentBackside_id){
               ...
               $id_photo_back = $user->organisationemployees()->first()->pivot->id_photo_back;
           }
    ...
    public function destroy($id)
    {
        ...
        if($user){
            $organisation = $user->organisationemployees()->first();
             $currentPassport = $user->organisationemployees()->first()->pivot->photo;
                 $ps_Path = public_path()."/assets/organisation/img/employees/passports/";
                 $S_currentPassport = $ps_Path. $currentPassport;
                     if(file_exists($S_currentPassport)){
        ...
        $organisation->organisationemployees()->detach($id);
        $user->delete();
    }
}
